...
object ExploreParameters extends App {
  ...
  val results = parameterGridSearch.exploreFlowGateFunctionalFormLinear((0,5), (-5,0))

  results.map(r => (r._1, r._2, r._3._1, r._3._2, r._3._3, r._3._4, r._3._5, r._3._6)).toVector.writeToCSV("exploration-results.csv")
