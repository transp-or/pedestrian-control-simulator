...
object OptimizeGatingStrategy extends App {
  ...
  fw.write("allPeds,withGates,withoutGates\n")
  fw.close()

  val x_only1 =   ContinuousProblem.problemInit(dimension, util.Arrays.asList(2.0, -2.0, -3.0), util.Arrays.asList(6.0 ,2.0 , 0.0))
