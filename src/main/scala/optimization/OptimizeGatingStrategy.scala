...
object OptimizeGatingStrategy extends App {
  ...
  fw.write("allPedsTTmedmed,allPedsTTvarmed,allPedsSize,withGatesTTmedmed,withoutGatesTTmedmed,withGatesTTvarmed,withoutGatesTTvarmed\n")
  fw.close()
  ...
  val fw = new FileWriter(config.getString("output.dir") + "/SO_gating_KPIs_" + ID + ".csv", true)
  fw.write("allPeds,allPedsSize,withGates,withoutGates\n")
  fw.close()
