...
/*
  ...
  fw.write("allPedsTTmedmed,allPedsTTvarmed,allPedsSize,withGatesTTmedmed,withoutGatesTTmedmed,withGatesTTvarmed,withoutGatesTTvarmed,allPedsTTmed75quant,withGatesTTmed75quant,withoutGatesTTmed75quant\n")
  fw.close()
  ...
  ContinuousProblem.optimizationDSA(5e3, 0.002, 0.05, new java.util.ArrayList[java.lang.Object](x_only1), factory1, title1, false)
...
*/
  ...
  val title1 = config.getString("output.dir") + "DSA_results_" + ID + ".txt"
  ContinuousProblem.optimizationDSA(2.4, 0.002, 0.05, new java.util.ArrayList[java.lang.Object](x_only1), factory1, title1, false)
