...
class AMWFlowsFromGroundTruth(population: Vector[PedestrianSim], movingWalkways: Vector[MovingWalkway], val intervals: Vector[Time]) extends DemandEstimate with AMWFlowsHelpers {
