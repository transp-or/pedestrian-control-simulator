...
/**
  ...
  */
class CreatePedestrian(val o: Vertex, val d: Vertex, val isTransfer: Boolean, sim: NOMADGraphSimulator)(implicit tag: ClassTag[PedestrianNOMAD]) extends Action {
