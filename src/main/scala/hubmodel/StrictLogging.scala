...
trait StrictLogging {
  ...
  protected val errorLogger: Logger = Logger(LoggerFactory.getLogger("hubmodel.DES.NOMADGraphSimulator"))

  val eventLogger: Logger = Logger(LoggerFactory.getLogger("hubmodel.DES.Action"))
